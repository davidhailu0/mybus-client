...
export default function PassengerForm({starting_place,destination_place,date}){
    ...
    const [departureDateValue,setDepartureDate] = useState(date||null)
    ...
    return <Box component={'form'} sx={{width:"70%",margin:"2rem auto"}}>
     ...
     <Button variant="contained" onClick={submitForm} sx={{backgroundColor:"#10c9a7",display:"block",margin:"auto",textAlign:"center",":hover":{backgroundColor:"black"}}}>
        Search
     </Button>
</Box>
}